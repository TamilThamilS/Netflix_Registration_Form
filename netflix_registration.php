<?php
    ...
    if(isset($_SESSION["user"])) {
        ...
        header("Location: netflix_index.php");
    }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="register-container mt-5">
            <?php
                ...
                if(isset($_POST["submit"])) {
                    ...
                    require_once("netflix_database.php");
                    ...
                    $sql = "SELECT * FROM netflix_registration_table WHERE email = '$email'";
                    ...
                    //if there is no error then we will insert the data.
                        ...
                        $sql = "INSERT INTO netflix_registration_table (full_name, email, password) VALUES( ?, ?, ? )";
            ...
            ?>
            <form action="netflix_registration.php" method="post">
                <div class="form-group m-3">
                    <input type="text" name="full_name" placeholder="Enter user name" class="form-control">
                </div>
                <div class="form-group m-3">
                ...
                <div class="form-group m-3">
                    <input type="password" name="conform_password" placeholder="Enter conform password" class="form-control">
                </div>
            ...
            <div class="ml-3">
                <p>Already Registered
                    <i class="fa-solid fa-arrow-right fa-beat ml-2 mr-2"></i>
                    <a href="netflix_login.php">Login Here</a>
                </p>
            </div>
        </div>
    </body>
